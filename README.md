...
当前版本为 [`v1.0.1`](https://github.com/Muggles001/muggles-music/releases/tag/v1.0.1)，这是麻瓜音乐的第二个稳定版本。本版主要升级双语同步歌词体验，并完善 TV 遥控器导航与 LXserver 播放接入。
...
- 歌单广场采用适合 D-Pad 遥控器的每页 12 项翻页导航。
