...
public class LoginWebServer extends NanoHTTPD {
    ...
    private String getHtml() {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "        input { width: 100%; min-height: 56px; padding: 12px 16px; border-radius: 16px; border: 1px solid rgba(148,178,162,0.60); background: rgba(255,255,255,0.82); color: #10231B; box-sizing: border-box; font-size: 16px; outline: none; }\n" +
                "        input:focus { border-color: #00A965; box-shadow: 0 0 0 3px rgba(0,200,120,0.16); }\n" +
