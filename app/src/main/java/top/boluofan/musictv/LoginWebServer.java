...
public class LoginWebServer extends NanoHTTPD {
    ...
    private String getHtml() {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "        input { width: 100%; padding: 12px; border-radius: 12px; border: 1px solid rgba(148,178,162,0.60); background: rgba(255,255,255,0.62); color: #10231B; box-sizing: border-box; font-size: 16px; outline: none; }\n" +
