...
public class LyricAdapter extends RecyclerView.Adapter<LyricAdapter.LyricViewHolder> {
    ...
    public void onBindViewHolder(@NonNull LyricViewHolder holder, int position) {
        ...
        if (isCurrent) {
            ...
            float cornerRadius = holder.itemView.getResources()
                    .getDimensionPixelSize(R.dimen.player_cover_corner_radius);
            holder.itemView.setBackground(
                    new SoftRoundedBackgroundDrawable(0x0CFFFFFF, cornerRadius));
        } else {
            // 距离越远透明度越低，自然渐出
